            ...
            <div className={styles.featuresGrid}>
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  Calendar integration to book 1:1s with US VCs, experienced operators, and successful alumni. Get direct access to the people who've walked your path.
                </p>
              </div>
              <div className={styles.featureCard}>
                <h3 className={styles.featureTitle}>Resource Library</h3>
                <p className={styles.featureDescription}>
                  Legal templates for "Flipping" (changing domicile to US), US hiring contracts, B2B sales scripts, and proven playbooks from successful cross-border startups.
                </p>
              </div>
              <div className={styles.featureCard}>
              ...
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  Connect with founders who've successfully bridged to the US market. Learn from their mistakes, celebrate their wins, and build lasting relationships.
                </p>
              </div>
            </div>
